...
test('renders ONE error message if user enters a valid first name and last name but no email.', async () => {
    ...
    userEvent.type(lastNameField, "roberts");
...
test('renders "email must be a valid email address" if an invalid email is entered', async () => {
    ...
    userEvent.type(emailField, "benjamin@gmail");
...
test('renders all firstName, lastName and email text when submitted. Does NOT render message if message is not submitted.', async () => {
    ...
    await waitFor(() => {
        ...
        const lastNameDisplay = screen.queryByText("roberts");
...
test('renders all fields text when all fields are submitted.', async () => {
    ...
    await waitFor(() => {
        const firstNameDisplay = screen.queryByText(/benjamin/i);
        const lastNameDisplay = screen.queryByText(/roberts/i);
